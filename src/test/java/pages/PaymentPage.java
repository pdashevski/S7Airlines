...
public class PaymentPage extends BasePage {
    ...
    public static final String submitButton = "//span[contains(text(),'Оплатить позже')]/ancestor::button";
    ...
    public void submitPassenger() {
        //isElementPresent(By.xpath(submitButton)); текст в кнопке меняется динамически
        driver.findElement(By.xpath(submitButton)).click();
        driver.findElement(By.xpath(submitButton)).click();
    }

    public void confirmCheckboxSelect() {
        //isElementPresent(By.xpath(confirmCheckbox));
